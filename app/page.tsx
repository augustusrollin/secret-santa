  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8 max-w-4xl">
        ...
        {/* Footer */}
        <footer className="text-center text-christmas-snow/80 font-body mt-6 sm:mt-8 md:mt-12">
          <p className="text-base sm:text-lg">🎄 Happy Holidays! 🎁</p>
          <p className="text-xs sm:text-sm mt-2">Secret Santa 2025 • Made with ❤️ and Christmas magic</p>
        </footer>
      </div>
    </main>
  );
